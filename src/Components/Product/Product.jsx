...
function Product() {
  ...
  const upcomingProductsData = useSelector(
    (state) => state.productsReducer.upcomingProductsData
  );
  const olderProductsData = useSelector(
    (state) => state.productsReducer.olderProductsData
  );
  const bestDealsData = useSelector(
    (state) => state.productsReducer.bestDealsData
  );
  const promotionalProductsData = useSelector(
    (state) => state.productsReducer.promotionalProductsData
  );
      ...
      <div className={styles.Product}>
        <div className={styles.Product__main}>
          <div className={styles.Product__main__head}>
            ...
            <div>
              <span onClick={() => setCurrentFilter("popular")}>POPULAR</span>{" "}
              <b>|</b>{" "}
              <span onClick={() => setCurrentFilter("latest")}>NEWEST</span>
            </div>
          </div>
          <div className={styles.Product__main__content}>
            ...
            <div
              onClick={showMoreTodayHandler}
              className={styles.Product__main__content__more}
            >
          ...
          <div className={styles.Product__main__content}>
            ...
            >
              ...
              <button>
                ...
                {showMoreOlder
                  ? "Show Less"
                  : `Show ${olderProductsData.length - 10} More`}
              </button>
            </div>
          </div>
        </div>
        <div className={styles.Product__side}>
          <div className={styles.Product__side__awards}></div>
          <div className={styles.Product__side__highlight}>
            <h2>
              Upcoming products <span>powered by Masai</span>
            </h2>
